...
const MIN_SINGLE_SENIOR_VALUE_USD = Number(process.env.CHATGPT_SP500_MIN_SINGLE_SENIOR_VALUE_USD || 1000000);
...
function retagSignal(signal, { today, freshnessLimit }) {
  ...
  return {
    ...
    reason: accepted
      ? `Conviccion insider S&P 500: ${actorText} ${verbText} ${Math.round(valueUsd).toLocaleString("en-US")} USD; filing ${filingDate}${filingAge == null ? "" : ` (${filingAge} dias)`}.`
