...
const CHATGPT_SP500_PORTFOLIO = {
  ...SHARED_PORTFOLIO,
  max_new_positions_per_day: Number(process.env.CHATGPT_SP500_MAX_NEW_POSITIONS_PER_DAY || SHARED_PORTFOLIO.max_open_positions),
  max_positions_per_sector: Number(process.env.CHATGPT_SP500_MAX_POSITIONS_PER_SECTOR || SHARED_PORTFOLIO.max_open_positions),
  max_hold_days: Number(process.env.CHATGPT_SP500_MAX_HOLD_DAYS || 5),
  max_loss_pct: pctConfig("CHATGPT_SP500_STOP_LOSS_PCT", 0.02),
  require_new_insider_event_after_exit: true,
  stop_reentry_cooldown_days: Number(process.env.CHATGPT_SP500_STOP_REENTRY_COOLDOWN_DAYS || 7),
  profit_lock: {
    first_trigger_pct: pctConfig("CHATGPT_SP500_PROFIT_LOCK_TRIGGER_PCT", 0.025),
    breakeven_lock_pct: pctConfig("CHATGPT_SP500_PROFIT_LOCK_BREAKEVEN_PCT", 0.001),
    second_trigger_pct: pctConfig("CHATGPT_SP500_PROFIT_LOCK_SECOND_TRIGGER_PCT", 0.04),
    second_lock_pct: pctConfig("CHATGPT_SP500_PROFIT_LOCK_SECOND_LOCK_PCT", 0.015),
  },
};
...
const WORKSPACES = {
  ...
  insider_total: {
    ...
    short: "ChatGPT SP500",
    description:
      "Compras fuertes de insiders del S&P 500: Form 4 codigo P/Dataroma, clusters, directivos senior, importe material y salida temporal a 5 dias.",
  ...
  insider_sp500_nasdaq: {
    id: "insider_sp500_nasdaq",
    label: "Insiders SP500+Nasdaq+NYSE",
    short: "SP500+Nasdaq+NYSE",
    description:
      "Compras fuertes de insiders del S&P 500, Nasdaq-100 y NYSE. Misma regla ChatGPT de conviccion, publicacion accionable y salida temporal a 5 dias.",
    strategy: "chatgpt_sp500_nasdaq",
    // Universo ampliado para comparacion, calculado por GitHub Actions cada
    // hora. Vercel solo sirve el snapshot para seguir en free tier.
    live: false,
    portfolio: CHATGPT_SP500_PORTFOLIO,
  },
};
