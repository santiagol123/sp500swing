...
const WORKSPACES = {
  ...
  insider_sp500_nasdaq: {
    ...
    short: "SP500+Nasdaq",
    description:
      "Compras fuertes de insiders del S&P 500 y Nasdaq-100. Misma regla ChatGPT de conviccion, publicacion accionable y salida temporal a 5 sesiones.",
    strategy: "chatgpt_sp500_nasdaq",
    // Universo ampliado, calculado por GitHub Actions cada hora igual que los
    // insiders. Vercel solo sirve el snapshot para seguir en free tier.
    live: false,
    portfolio: CHATGPT_SP500_PORTFOLIO,
  },
};
